<?php
error_log("\n check " . "BOT REC "  . date("d/m/Y h:i:s") . " === da vao dau nhan Mien Trung === : \n", 3, "/var/log/bitrix/my.log");
file_put_contents("logC.txt", "=== da vao dau nhan Mien Trung === " . "\n", FILE_APPEND);
...
//});
$botman->hears('{message}', function ($bot, $message) use ($TOKEN,$FILE_API_URL,$CONFIG_ID,$LICENSE_KEY){
    $user = $bot->getUser();
//      ob_flush();
//      ob_start();
//      print_r($user);
